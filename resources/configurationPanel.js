...
"configurationSettings":[
        ...
        "category": "Imagery",
                ...
                "type": "conditional",
                        ...
                        "tooltip": "Let users choose one or more imagery layers to view.",
                        "label": "Enable Imagery Layer Selector",
                        "items": [
                        {
                        "type": "radio",
                                ...
                                {
                                "label": "Two-Layer Comparison Viewer with Swipe",
                                        "value":"multi"
                                }
                                ]
                        },
                        ...
                        {
                        "type":"boolean",
                                "label": "Enable renderer dropdown",
                                "fieldName": "renderingFlag",
                                "tooltip": "Let users visualize imagery using RFTs from the image service."
                        },
                        {
                        "type":"multilayerandfieldselector",
                                "fieldName":"imageSelectorLayer",
                                "label":"Choose imagery layer(s) to search for specific images, and select a field to search:",
                                "tooltip":"Let users search for specific images using a field(e.g. search by Acquisition Date)",
                                "layerOptions":{
                                "supportedTypes":[
                                        "ImageServiceLayer"
                                ]
                        ...
                        "type": "conditional",
                                ...
                                "tooltip": "Refine the user's search experience.",
                                "label": "Advanced Image Selector Options",
                                "items": [
                                {
                                "type":"Number",
                                        "fieldName":"zoomLevel",
                                ...
                                "type":"boolean",
                                        ...
                                        "tooltip":"If unchecked, image search results will group images together by the search field."
                                },
                                {
                                "type":"boolean",
                                        "fieldName":"enableAutoRefresh",
                                        "label":"Enable AutoRefresh",
                                        "toottip":"Automatically refresh search results if the user pans or zooms."
                                },
                                {
                                "type":"boolean",
                                        "fieldName":"rangeFlag",
                                        "label":"Enable Search Range",
                                        "toottip":"Let users search a range of dates for images."
                                },
                                {
                                "type":"boolean",
                                        "fieldName":"showFlag",
                                        "label":"Enable Show(image or footprint)",
                                        "toottip":"Let users toggle between viewing images and footprints."
                                },
                                {
                                "type":"options",
