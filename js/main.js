...
define([
    ...
    registry, exportHtml, bookmarkHtml, singleLayerViewerHtml, twoLayerViewerHtml, coordinateHtml, Tooltip,
    arcgisUtils,
        ...
        return declare(null, {
            ...
            startup: function (config) {
                ...
                if (config) {
                    ...
                    document.getElementById("secondaryDate").style.color = this.config.color;
            ...
            createCSSRules: function () {
                ...
                var cssRules = {
                    ".titleBar": "width: 100%;height: 39px;background-color:" + this.config.widgetTitleColor + ";color:white;font-size: 1.3em;font-weight: bolder;",
            ...
            setupImageDate: function () {
                ...
                if (this.config.imageDateLayer) {
                    ...
                    for (var a = 0; a < layers.length; a++) {
                        if (layers[a].url && layers[a].url.toLowerCase() === this.worldImagery.toLowerCase()) {
                            layer[layers[a].id] = {
                                dateField: "SRC_DATE2",
                ...
                this.imageDate = new ImageDate({ map: this.map, layers: layer, prefix: this.config.imageDateLabel, i18n: this.config.i18n.imageDate, viewerTool: this.config.viewerTool});
            ...
            setupExport: function () {
                ...
                this.exportFunction = new Export({
                    map: this.map,
            ...
            setupLayerViewer: function (viewerType) {
                ...
                if (!this.config.primaryLayer.id && viewerType === "singleLayerViewer" && !this.config.operationalLayersFlag && !this.config.exportFlag && !this.config.basemapFlag && !this.config.bookmarkFlag && !this.config.scalebarFlag && !this.config.imageDateFlag && !this.config.measurementFlag && !this.config.search) {
