...
define({
  ...
  "singleLayerViewer": {
    "title": "Bildelagvelger",
    "enable": "Søk etter enkeltbilder",
    "tooltip": "Aktiver for å søke etter bestemte bilder.",
    "secondary": "Sett aktivt lag som sammenligningslag.",
    "dropDown": "Vis bilder i nedtrekksmenyen.",
    "refresh": "Oppdater-knapp",
    "refreshTooltip": "Oppdater spørring på bakgrunn av nåværende utstrekning.",
    "renderer": "Gjengivelse",
    "layer": "Lag",
    "show": "Vis",
    "age": "Søkeområde",
    ...
    "error8": "Bildedata kun tilgjengelig mellom ",
    "error9": "Ugyldig datoområde. Startdato må være før sluttdato.",
  ...
  "twoLayerViewer": {
    ...
    "left": "Venstre bilde",
    "right": "Høyre bilde",
    "identicalLayerError": "Venstre og høyre bilde er identiske.",
    "date": "Dato(er)",
    "imageLabel": "bilde(r)",
    "default": "Standard"
  },
  ...
  "export": {
    ...
    "error4": "for for denne utstrekningen.",
